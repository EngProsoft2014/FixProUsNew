...
public partial class InvoiceDetailsPage : Controls.CustomsPage
{
    ...
    public InvoiceDetailsPage(CustInvoicesViewModel model, IGenericRepository GenericRep, Services.Data.ServicesService service)
	{
		InitializeComponent();
        ORep = GenericRep;
        _service = service;
    ...
    {
        custInvoicesViewModel.TotalInvoice(custInvoicesViewModel.OneInvoice);
    }
}